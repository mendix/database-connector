 ...
 * perform an arbitrary parameterized SELECT SQL query on relational external
 * databases. JDBC (Java Database Connectivity) API, a standard Java API, is
 * used when this Java action attempts to connect with a Relational Database for
 * which a JDBC driver exists. The JDBC drivers for the databases you want to
 * connect to, must be placed inside the userlib directory of a project.
 * </p>
 * 
 ...
 *                          database.
 * 
 * @param <String>          userName The user name for logging into the
 *                          database, relative to the jdbcUrl argument.
 * 
 * @param <String>          password The password for logging into the database,
 *                          relative to the jdbcUrl argument.
 * 
 * @param <IStringTemplate> sql A string template containing the SELECT query to
 *                          be performed and the query parameters, relative to
 *                          the database type.
 * 
 * @param <String>          resultObjectType A fully qualified name of the
 *                          result object type. Concrete <IMetaObject> can be
 *                          retrieved with a call to `Core.getMetaObject`.
 * 
