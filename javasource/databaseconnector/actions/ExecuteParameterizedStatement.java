 ...
 * perform an arbitrary parameterized SQL statement on relational external
 ...
 * 
 * @param <IStringTemplate> sql A string template containing the SQL statement
 *                          to be performed and the statement parameters,
 *                          relative to the database type.
 * 
